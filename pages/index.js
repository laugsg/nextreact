...
import { Accordion, MultiAccordion } from "../vanilla-styles/components/markup/Accordion";
    ...
    <div className={`${themeBox} ${themeDefaultButton} ${themeColors}`}>
      ...
      >
        ...
        >
          ...
          <p style={{ margin: "0px" }}>
            Every file in this proyect has comments and its commented for learning purposes.
          </p>
        </div>
      </div>
    </div>
